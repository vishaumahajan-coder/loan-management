      ...
      <div className="flex-1 lg:w-[45%] xl:w-[42%] bg-white flex flex-col justify-center items-center p-8 h-full relative overflow-y-auto">
        <div className="w-full max-w-[480px]">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <p className="text-center text-[10px] text-gray-400 font-bold uppercase tracking-tight mt-2">
              NEW LENDER?{' '}
              <button
                type="button"
          ...
          <div className="mt-6 pt-4 border-t border-gray-50 flex flex-col items-center">
            <p className="text-[10px] font-black text-gray-300 uppercase tracking-[0.4em] mb-4">DEMO ROLES</p>
